...
#### ✨문제 및 문제해결 <br>
1. 데이터 접근과 사용<br>
 데이터를 요청하고 가져올 때, 어떤 데이터를 가져와야 하는지 정확한 이해가 부족했고, 가져온 데이터에 어떻게 접근해야 원하는 값을 출력할 수 있을지에 대한 부분에 어려움을 겪었습니다<br>
이와 같은 문제점을 해결하기 위해 출력을 해보면서 어디까지 데이터가 도출되었고 어떻게 접근해야 하는지 확인하는 방법을 알게되었습니다.

2. 알고리즘<br>
 문제해결을 하기 위해서 어떻게 접근해야 하는지 파악하는데 어려움을 겪었습니다.<br>
최종적으로 구현할 목표는 알고 있지만 단계별로 접근하는 것에 대한 어려움이 있었는데 이번 프로젝트를 진행하면서 문제를 해결하기 위해 큰 문제를 작은 부분 문제로 나누고 각각을 해결하는 과정을 분해하는 방법을 익히게 되었습니다.<br>
이러한 분해 작업은 복잡한 문제를 관리 가능한 작업으로 나누는 데 도움이 되었습니다.

#### ✨총평<br>
1. 팀워크와 책임감<br>
 이번 프로젝트에서 의사소통 및 팀 내에서 자신을 역할을 명확히 이해하고 책임감있게 수행하는 것에 대한 중요성을 알게 되었습니다.<br>
 성공적인 협업을 위해서는 원활한 의사소통이 이루어져야 서로 간의 오해를 줄일 수 있고 불필요한 충돌도 줄일 수 있다는 걸 배우는 계기가 되었습니다.<br>
 이번 프로젝트에서는 팀원들 간의 의사소통이 원활히 되었고, 각자 자신의 맡은 역할에 최선을 다했기 때문에 더 좋은 결과물을 얻을 수 있었다고 생각합니다.<br>
